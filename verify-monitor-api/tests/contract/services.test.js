...
describe('Contract Test: GET /api/services', () => {
    ...
    it('should return all services with correct structure', async () => {
        ...
        const response = await (0, supertest_1.default)(app).get('/api/services').expect(200);
        ...
        const serviceIds = response.body.services.map((s) => s.id);
    ...
    it('should return 500 on database error', async () => {
        ...
        const response = await (0, supertest_1.default)(app).get('/api/services').expect(500);
    ...
    it('should respond within 200ms (performance requirement)', async () => {
        ...
        await (0, supertest_1.default)(app).get('/api/services').expect(200);
